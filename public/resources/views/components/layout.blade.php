...
<head>
    ...
    <style>
        /* ================================================================
           ...
           ================================================================
           Color Palette:
             --green-deep   : Deep Forest Green, primary brand color
             --green-mid    : Fern Green for gradients
             --green-accent : Sage Green Accent
        ...
        :root {
            --green-deep:    #1A4D2E; /* Deep Forest Green */
            --green-mid:     #4F7942; /* Fern Green */
            --green-accent:  #8FBC8F; /* Sage Green Accent */
            --gold-primary:  #C9952C; /* Classic Deep Gold */
            --gold-light:    #E8C46A; /* Light Gold */
            --gold-pale:     #F5E6A3;
            --ivory:         #F4F9F4; /* Mint Cream Background */
            --ivory-dark:    #E2EBE2;
            --sidebar-width: 260px;
            --navbar-height: 64px;
            --text-dark:     #1A2F23; /* Dark Green-Black */
            --text-muted:    #5C7A63; /* Muted Green-Grey */
        }
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        #sidebar {
            ...
            height: 100vh;
            background: linear-gradient(180deg, var(--green-deep) 0%, #0A1F12 100%);
            z-index: 1050;
        ...
        #topNavbar {
            ...
            align-items: center;
            padding: 0 24px;
            box-shadow: 0 2px 12px rgba(26, 77, 46, 0.38);
        ...
        /* ── Welcome Banner ────────────────────────────────────────── */
        .welcome-banner {
            background: linear-gradient(135deg, var(--green-deep) 0%, var(--green-mid) 55%, #143D23 100%);
            border-radius: 16px;
            padding: 36px;
            color: white;
            position: relative;
            overflow: hidden;
            box-shadow: 0 8px 32px rgba(26, 77, 46, 0.28);
            margin-bottom: 28px;
        }
        ...
        .stat-card:hover {
            ...
            box-shadow: 0 10px 32px rgba(26, 77, 46, 0.14);
        ...
        .stat-growth.negative { color: var(--green-accent); }
        ...
        .quick-action-card:hover {
            ...
            box-shadow: 0 8px 24px rgba(26, 77, 46, 0.22);
        }
        .qa-icon {
            font-size: 1.75rem;
            margin-bottom: 8px;
        ...
        .badge-event   { background: rgba(79, 121, 66, 0.1); color: var(--green-mid); }
        .badge-booking { background: rgba(201, 149, 44,  0.1); color: #9A6D10;           }
        .badge-vendor  { background: rgba(26, 77, 46,  0.1); color: var(--green-deep);}
