{{-- ================================================================
     DANDIYAMA ADMIN PANEL — DASHBOARD
     ================================================================
     This is the main dashboard view loaded after login.
     It extends the shared admin layout and fills three content rows:

       Row 1 — Welcome banner
       Row 2 — Overview statistics (KPI cards)
       Row 3 — Quick actions  +  Recent bookings table
       Row 4 — Upcoming events  +  Module status grid

     HOW TO WIRE UP REAL DATA (future developer):
       Create app/Http/Controllers/Admin/DashboardController.php
       and return the required variables to this view, e.g.:
         ...
         public function index()
         {
             return view('dashboard', [
                 ...
                 'recentBookings' => \App\Models\Booking::with('customer','event')
                                         ->latest()->take(5)->get(),
       ...
       Then replace all dummy values and @php blocks below with those variables.
================================================================ --}}
